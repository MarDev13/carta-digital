...
function actualizarVistaPedido() {
  ...
  pedido.forEach(item => {
    ...
    linea.classList.add('d-flex', 'justify-content-between', 'align-items-center', 'mb-2');

    linea.innerHTML = `
      <span>${item.nombre} x${item.cantidad}</span>
      <button id="btn-delete" class="btn btn-sm btn-danger" onclick="eliminarDelPedido('${item.nombre}')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
